...
def extrair_video(driver, link):
    """Extrai dados do vídeo - com espera automática maior"""
    video_data = {
        'video_link': link,
        'criador': None,
        'descricao': None,
    ...
    try:
        # Aguarda o vídeo carregar automaticamente
        ...
        try:
            ...
            video_data['descricao'] = desc.text[:500]
            hashtags = []
        ...
        print(f"   👤 {video_data['criador']} | 👍 {video_data['likes']} | 💬 {video_data['comentarios']}")
